// src/app/dashboard-detalhe/page.tsx
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg h-96">
            <h3 className="font-semibold text-lg mb-4 border-b pb-2">Meta vs. Realizado (Mensal)</h3>
            <div className="h-4/5">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg h-96">
            <h3 className="font-semibold text-lg mb-4 border-b pb-2">Distribuição de Riscos</h3>
            <div className="h-4/5">
